...
insert into cartera (credito_id,nombre,ejecutivo,frecuencia,tipo_credito,capital,pg_cap,pg_int,pct_cap,pct_int,pagos,abono,impuntual,comision_apertura,saldo,saldo_capital,saldo_interes,tasa,surtimiento,vencimiento,estatus) values
  ('SEED-SEMANAL-1','JUAN SEMANAL','CESAR','SEMANAL','SIMPLE',10000,1000,200,0.8333,0.1667,10,1200,1300,0,12000,10000,2000,0,'2026-06-24','2026-07-05','ACTIVO');
...
insert into cartera (credito_id,nombre,ejecutivo,frecuencia,tipo_credito,capital,pg_cap,pg_int,pct_cap,pct_int,pagos,abono,impuntual,comision_apertura,saldo,saldo_capital,saldo_interes,tasa,surtimiento,vencimiento,estatus) values
  ('SEED-QUINCENAL-2','MARIA QUINCENAL','LORENA','QUINCENAL','SIMPLE',12000,2000,300,0.8696,0.1304,6,2300,2500,0,13800,12000,1800,0,'2026-06-24','2026-07-15','ACTIVO');
insert into calendarios (cartera_id,id_credito,cliente,n_pago,fecha,monto_puntual,monto_impuntual,capital,interes,pagado,estatus) values
...
insert into cartera (credito_id,nombre,ejecutivo,frecuencia,tipo_credito,capital,pg_cap,pg_int,pct_cap,pct_int,pagos,abono,impuntual,comision_apertura,saldo,saldo_capital,saldo_interes,tasa,surtimiento,vencimiento,estatus) values
  ('SEED-MENSUAL-3','PEDRO MENSUAL','CESAR','MENSUAL','SIMPLE',15000,3000,600,0.8333,0.1667,5,3600,3800,1000,18000,15000,3000,0,'2026-06-24','2026-07-24','ACTIVO');
insert into calendarios (cartera_id,id_credito,cliente,n_pago,fecha,monto_puntual,monto_impuntual,capital,interes,pagado,estatus) values
  ((select id from cartera where credito_id='SEED-MENSUAL-3'),'SEED-MENSUAL-3','PEDRO MENSUAL',1,'2026-07-24',3600,3800,3000,600,0,'PENDIENTE'),
  ((select id from cartera where credito_id='SEED-MENSUAL-3'),'SEED-MENSUAL-3','PEDRO MENSUAL',2,'2026-08-24',3600,3800,3000,600,0,'PENDIENTE'),
  ((select id from cartera where credito_id='SEED-MENSUAL-3'),'SEED-MENSUAL-3','PEDRO MENSUAL',3,'2026-09-24',3600,3800,3000,600,0,'PENDIENTE'),
  ((select id from cartera where credito_id='SEED-MENSUAL-3'),'SEED-MENSUAL-3','PEDRO MENSUAL',4,'2026-10-24',3600,3800,3000,600,0,'PENDIENTE'),
  ((select id from cartera where credito_id='SEED-MENSUAL-3'),'SEED-MENSUAL-3','PEDRO MENSUAL',5,'2026-11-24',3600,3800,3000,600,0,'PENDIENTE');

-- ATRASADO (LUIS ATRASADO)
insert into cartera (credito_id,nombre,ejecutivo,frecuencia,tipo_credito,capital,pg_cap,pg_int,pct_cap,pct_int,pagos,abono,impuntual,comision_apertura,saldo,saldo_capital,saldo_interes,tasa,surtimiento,vencimiento,estatus) values
  ('SEED-ATRASADO-4','LUIS ATRASADO','LORENA','SEMANAL','SIMPLE',8000,1000,100,0.9091,0.0909,8,1100,1250,0,8800,8000,800,0,'2026-06-24','2026-05-03','ACTIVO');
insert into calendarios (cartera_id,id_credito,cliente,n_pago,fecha,monto_puntual,monto_impuntual,capital,interes,pagado,estatus) values
  ((select id from cartera where credito_id='SEED-ATRASADO-4'),'SEED-ATRASADO-4','LUIS ATRASADO',1,'2026-05-03',1100,1250,1000,100,0,'PENDIENTE'),
  ((select id from cartera where credito_id='SEED-ATRASADO-4'),'SEED-ATRASADO-4','LUIS ATRASADO',2,'2026-05-10',1100,1250,1000,100,0,'PENDIENTE'),
  ((select id from cartera where credito_id='SEED-ATRASADO-4'),'SEED-ATRASADO-4','LUIS ATRASADO',3,'2026-05-17',1100,1250,1000,100,0,'PENDIENTE'),
  ((select id from cartera where credito_id='SEED-ATRASADO-4'),'SEED-ATRASADO-4','LUIS ATRASADO',4,'2026-05-24',1100,1250,1000,100,0,'PENDIENTE'),
  ((select id from cartera where credito_id='SEED-ATRASADO-4'),'SEED-ATRASADO-4','LUIS ATRASADO',5,'2026-05-31',1100,1250,1000,100,0,'PENDIENTE'),
  ((select id from cartera where credito_id='SEED-ATRASADO-4'),'SEED-ATRASADO-4','LUIS ATRASADO',6,'2026-06-07',1100,1250,1000,100,0,'PENDIENTE'),
  ((select id from cartera where credito_id='SEED-ATRASADO-4'),'SEED-ATRASADO-4','LUIS ATRASADO',7,'2026-06-14',1100,1250,1000,100,0,'PENDIENTE'),
  ((select id from cartera where credito_id='SEED-ATRASADO-4'),'SEED-ATRASADO-4','LUIS ATRASADO',8,'2026-06-21',1100,1250,1000,100,0,'PENDIENTE');

-- LIQUIDADO (ANA LIQUIDADA)
insert into cartera (credito_id,nombre,ejecutivo,frecuencia,tipo_credito,capital,pg_cap,pg_int,pct_cap,pct_int,pagos,abono,impuntual,comision_apertura,saldo,saldo_capital,saldo_interes,tasa,surtimiento,vencimiento,estatus) values
  ('SEED-LIQUIDADO-5','ANA LIQUIDADA','CESAR','MENSUAL','SIMPLE',9000,3000,300,0.9091,0.0909,3,3300,3500,0,0,0,0,0,'2026-06-24','2026-03-24','LIQUIDADO');
insert into calendarios (cartera_id,id_credito,cliente,n_pago,fecha,monto_puntual,monto_impuntual,capital,interes,pagado,estatus) values
  ((select id from cartera where credito_id='SEED-LIQUIDADO-5'),'SEED-LIQUIDADO-5','ANA LIQUIDADA',1,'2026-03-24',3300,3500,3000,300,3300,'PAGADO'),
  ((select id from cartera where credito_id='SEED-LIQUIDADO-5'),'SEED-LIQUIDADO-5','ANA LIQUIDADA',2,'2026-04-24',3300,3500,3000,300,3300,'PAGADO'),
  ((select id from cartera where credito_id='SEED-LIQUIDADO-5'),'SEED-LIQUIDADO-5','ANA LIQUIDADA',3,'2026-05-24',3300,3500,3000,300,3300,'PAGADO');
